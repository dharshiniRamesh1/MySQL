create table employee1(E_id int,E_name varchar(20) not null,salary int,age int,gender varchar(20),D_O_J varchar(20),primary key(E_id));
use employee;
INSERT INTO employee1 (E_id, e_name, salary, age, gender, D_O_J) VALUES
(1001, 'John Doe', 3200, 25,  '2023-04-15'),
...
select*from employee1 where salary>4000;
select*from  employee1 where  gender="female";
select*from employee1 where D_O_J="2023-07-17";
select*from  employee1 where  age=30;
select*from  employee1 where salary between 3000 and 4000;
select E_id from employee1;
delete employee1 from employee1 where e_id=1098;
select*from  employee1 where e_id=1098;
select*from employee1 where E_id=1100;
update employee1 set age=25 where e_id=1100 and 1002;
select * from employee1 order by E_name DESC;
select * from employee1 order by salary ,age desc;
select count(Salary)
from employee1
where salary<1000;
select sum(salary)
...
from employee1
group by salary;
select age,count(age) from employee1 where age=25 group by age;
select salary,count(salary) from employee1 where salary>3000 group by salary;
